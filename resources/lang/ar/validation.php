    ...
    */
    ...
    'custom' => [
        ...
        'category' => [
            ...
            'required' => 'فضلا اختر الفئة'
        ],
        'subject' => [
            'required' => 'فضلا ادخل عنوان الشكوى'
        ],
        'project' => [
            'required' => 'فضلا ادخل اسم المشروع'
        ],
        'url' => [
            'required' => 'فضلا ادخل رابط المشروع',
            'url' => 'فضلا ادخل رابط صحيح'
        ],
        'body' => [
            'required' => 'فضلا ادخل تفاصيل الشكوى'
        ],
    ],
